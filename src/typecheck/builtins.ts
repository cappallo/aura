import type { InferState, TypeFunction } from "./context";
import { BOOL_TYPE, INT_TYPE, STRING_TYPE, UNIT_TYPE, freshTypeVar, makeFunctionType, makeListType, makeOptionType } from "./context";
